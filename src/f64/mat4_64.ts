...
/**
 * Creates a new identity mat4_64
 *
 * @returns {mat4_64} a new 4x4 matrix
 */
export function create(): mat4_64 {
...
/**
 * Create a new mat4_64 with the given values
 *
...
const fromQuat2_temp_translation = new Float64Array(3);
...
const getRotation_temp_scaling = new Float64Array(3);
